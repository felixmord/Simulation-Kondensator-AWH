...
df_input = pd.read_csv(
    "/Users/felixmord/BHT/Semester3/Messdaten Messkampagne 2 Kondensatoren/Plastikschlauch 150 um/2025-05-09 085022 Plastikschlauch 150 um Des feucht.txt",
    sep="\t",
    skiprows=[1],
    encoding="latin1"
)
...
for name, matrix in result_matrizen.items():
    ...
    file_path = os.path.join("/Users/felixmord/BHT/Semester3/Python/Kondensator Berechnung/Simulation dynamisch/Plastikschlauch 150 um/2025-05-09 085022 Plastikschlauch 150 um Des feucht", f"{safe_name}.xlsx")
    
    file_path1 = os.path.join("/Users/felixmord/BHT/Semester3/Python/Kondensator Berechnung/Simulation dynamisch/Plastikschlauch 150 um/2025-05-09 085022 Plastikschlauch 150 um Des feucht/df_kondensatmenge_gesamt.xlsx")
    file_path2 = os.path.join("/Users/felixmord/BHT/Semester3/Python/Kondensator Berechnung/Simulation dynamisch/Plastikschlauch 150 um/2025-05-09 085022 Plastikschlauch 150 um Des feucht/df_input.xlsx")
